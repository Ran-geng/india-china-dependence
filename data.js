...
const TRANSSHIPMENT_TRADE = [
    ...
    },
    {
      ...
      china: {
        ...
        note: "UN Comtrade 中国海关 HS 8542（含 8542.31 + 8542.32 + 8542.39 全章组，对港出口，2021–2024）｜2025 为行业报告口径：中国对香港出口集成电路（8542）$875.1 亿（+29.5%，中国机电产品贸易大数据报告 2025）；UN Comtrade 2025 中国官方数据延迟发布"
      },
      india: {
        source: 130,
        years: {
...
const POLICIES = {
  ...
  china: [
    ...
    { year: "2026-09-15", title: "出入境新规：出口管制违规者不准出境（国务院 841 号令）", desc: "国务院第 841 号令《出境入境管理》新规（2026-07-31 公布、09-15 施行）第 4 条：中国公民违反出口管制、技术进出口管理，可能危害国家产业安全/技术安全的，主管部门可决定不准出境。补上「以人为载体」的技术外流缺口（此前 2025 系列管制管「物」、此规管「人」）；彭博 2026-08-04 报道塔塔 Agratas 评估与中国电池技术合作可能性「几乎为零」，被迫自研 LFP[156]。", source: 156 }
  ]
};
