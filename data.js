...
const TRANSSHIPMENT_TRADE = [
  { chain: ["中国", "越南", "印度"], goods: "手机及零部件（智能手机 8517.13 主体）", hs: "8517.13",
    ...
    note: "UN Comtrade 中国海关（HS 8517 整体含手机/基站/通信设备）"
    },
    india: {
    source: 132,
    years: {
    ...
    note: "越南海关 GSO：手机及零部件对印出口 2022 $1,520M / 2023 $1,030M / 2024 $1,650M / 2025 $2,100M（+27%）（asemconnectvietnam.gov.vn、vietnamplus）2021 越南海关 GSO 未单独公布对印手机出口额"
    },
  ...
  { chain: ["中国", "越南", "印度"], goods: "集成电路（微处理器等 8542.31 主体）", hs: "8542.31",
    ...
    note: "UN Comtrade 中国海关（HS 8542 集成电路整章）"
    },
    india: {
    source: 132,
    years: {
    ...
    note: "越南海关 GSO：计算机/电子产品及零部件商品组对印出口 2022 $1,030M / 2023 $1,940M (+88%) / 2024 $1,500M / 2025 $1,700M（+15.8%）；合 8542+8524 整机口径"
    },
    note: "双升：中国→越南 IC/电子 2024 达 $16,500M 创历史新高，越南→印度电子组 2025 $1,700M 续升；印度对越南电子依赖（IC、显示模组、电容电阻等）受印方海关重点核查（CBIC 14/2025）",
    sources: [130, 132, 85] },
  { chain: ["中国", "越南", "印度"], goods: "工程机械（前装/挖掘机 8429.51 主体）", hs: "8429.51",
    ...
    note: "UN Comtrade 中国海关 HS 8429（含 8429.51 前装、8429.59 其他）"
    },
    india: {
    source: 132,
    years: {
    ...
    note: "越南海关 GSO：机械设备对印出口商品组（8429+8426 等）2024 $940M / 2025 $1,050M（+11.3%）；2023 $8,490M 为越对印总出口额参照"
    },
    note: "对比观察：中国→越南 8429 2024 略降，但越南→印度机械组仍增长 11.3%。越南对印出口结构以机械/纺织/化工等基础工业品为支柱；机械类是越对印出口稳定的支柱类目",
    sources: [130, 132] },
  { chain: ["中国", "泰国", "印度"], goods: "多晶硅料（光伏上游 2804.61）", hs: "2804.61",
    ...
    note: "UN Comtrade 中国海关 HS 2804.61"
    },
    india: {
    source: 139,
    years: {
    ...
    note: "印度 PIB 官方太阳能组件进口数据（HS 8541.43）：泰国对印出口 2019-20 $120M / 2020-21 $19M / 2021-22 $0.01M 后趋近零（印度不再经泰进口光伏链组件）"
    },
    note: "中国→泰国多晶硅暴增，但泰国近年对印出口光伏链商品几乎归零——因为印度 2022 年起对光伏组件加 25% BCD + ALMM 限制（HS 8541.43）使经泰转口路径被抑制；中-泰-印多晶硅链已在 2022 后基本切断",
    sources: [130, 139] },
  { chain: ["中国", "印度尼西亚", "印度"], goods: "太阳能级硅片（光伏上游 3818.00）", hs: "3818.00",
    ...
    note: "UN Comtrade 中国海关 HS 3818.00"
    },
    india: {
    source: 140,
    years: {
    ...
    note: "OEC（CEPII BACI 镜像）：印尼→印度 HS 3818.00 历年公开数据稀缺；OEC 单年镜像有数值（2024 ~$7.45M，含 3818.00 + 光伏上游组件，商品级口径略宽）。HS 3818.00 在印度对华进口口径为主、对印尼侧无逐年可获单 HS 数据"
    },
    ...
    sources: [130, 140, 139, 112] },
  { chain: ["中国", "马来西亚", "印度"], goods: "多晶硅料（光伏上游 2804.61）", hs: "2804.61",
    ...
    note: "印度 PIB（HS 8541.42）：马来对印出口 2019-20 $3.91M / 2020-21 $7.46M / 2021-22 $31.43M / 2022-23 $1.24M / 2023-24 $43.08M（+88%，Dewan Rakyat 答复）。马来西亚 MITI 官方 RM3.69B 折美元（光伏电池对印 +88%）"
    },
    ...
    sources: [130, 138, 139, 87] },
  { chain: ["中国", "新加坡", "印度"], goods: "盾构机（隧道掘进机 8430.31）", hs: "8430.31",
    ...
    note: "UN Comtrade 中国海关 HS 8430.31"
    },
    india: {
    source: 134,
    years: {
    ...
    note: "SingStat 新加坡对印出口总贸易额 2021 $13,400M / 2022 $13,900M / 2023 $14,400M / 2024 $15,100M（UN Comtrade）。HS 8430 在新加坡对印出口中占比极小，TBM 类目几乎无出口；为商品级缺口"
    },
    ...
    sources: [130, 134, 72] },
  { chain: ["中国", "阿联酋", "印度"], goods: "盾构机（隧道掘进机 8430.31）", hs: "8430.31",
    ...
    note: "阿联酋 FCSC/Trading Economics（UN Comtrade 镜像）：阿联酋对印总出口 2023 $32,000M / 2024 $33,620M（印度是其第一大出口伙伴）。HS 8430 在对印结构中占比小"
    },
    note: "阿联酋 NEOM / 迪拜地铁等大型基建推动中国 TBM 出口暴增（$5M → $225M）。印度海关已查处多起「经 GCC 转口」案例（DRI 2024-12 迪拜转口化妆品低估 70%），GCC 为印度关注的中转通道之一",
    sources: [130, 135, 116] },
  { chain: ["中国", "阿联酋", "印度"], goods: "工程机械 · 履带/汽车起重机（8426.49）", hs: "8426.49",
    ...
    note: "UN Comtrade 中国海关 HS 8426（含 8426.41 + 8426.49）"
    },
    india: {
    source: 135,
    years: {
    ...
    note: "同阿联酋对印总贸易口径（Trading Economics / UN Comtrade）。HS 8426 在阿联酋→印度结构中占比极小（起重机类目无公开 HS 6 位印度明细）"
    },
    note: "中国→阿联酋吊车 2024 $229M（+149%）。阿联酋为中东工程机械集散地，中资履带吊经 GCC 向印度交付公开案例与海关 GCC 原产地核查并存",
    sources: [130, 135, 116] },
  { chain: ["中国", "泰国", "印度"], goods: "锂离子蓄电池（8507.60）", hs: "8507.60",
    ...
    note: "UN Comtrade 中国海关 HS 8507.60"
    },
    india: {
    source: 137,
    years: {
    ...
    note: "Trendonify（UN Comtrade 镜像）：泰国对印总出口 2021 $8,590M / 2022 $10,530M / 2023 $10,120M / 2024 $11,750M。HS 8507.60 在泰国对印中占比小，电动车配件体现为商品组"
    },
    ...
    sources: [130, 137, 66, 75] },
  { chain: ["中国", "新加坡", "印度"], goods: "玩具（玩偶/三轮车及其他，9503.00 主体）", hs: "9503.00",
    ...
    note: "UN Comtrade 中国海关 HS 9503.00"
    },
    india: {
    source: 126,
    years: {
    ...
    note: "印度商工部 FY2018-19 → FY2021-22 官方：印度 HS 9503 自全球进口总额从 $304M 降至 $36M（同期自全球总进口从 $371M 降至 $110M），对印玩具基本被抑制。新加坡中转 $13.1M（印度海关 The Dollar Business）但无逐年明细"
    },
    ...
    sources: [130, 126] },
  { chain: ["中国", "印度尼西亚", "印度"], goods: "太阳能电池（8541.42 主体）", hs: "8541.42",
    ...
    note: "UN Comtrade 中国海关 HS 8541（含 8541.42 + 8541.43）"
    },
    india: {
    source: 140,
    years: {
    ...
    note: "OEC / HS 8541.42 印尼→印度：2024 $7.45M（2023→2024 +$5.38M，+260%）。印尼 HS 8541.43 主要出口美国（2024 $553M，对印占比小）"
    },
    note: "中国→印尼光伏组件+电池 2024 $346M（+69%）；印尼 PertSolaris/LONGi/Trina Sinar Mas 合资产能向印出口。HS 8541.42 印尼→印度激增 +260% 揭示印尼电池正在对印出口形成新增长",
    sources: [130, 140, 112] },
  { chain: ["中国", "阿联酋", "印度"], goods: "锂离子蓄电池（8507.60）", hs: "8507.60",
    ...
    note: "阿联酋 FCSC/UN Comtrade 镜像：阿联酋对印总出口 2023 $32,000M / 2024 $33,600M（India 是其第一大出口伙伴）。HS 8507 在对印商品结构中占比极小，无公开 HS 6 位明细"
    },
    note: "中国→阿联酋电池 2024 $415M（+63%）；阿联酋是 CEPA 框架下 GCC 进口电子与电池关键通道。印度海关对 UAE 原产地加强核查，已查处 Mundra 海关 Show Cause 案（UAE CEPA 虚假产地）",
    sources: [130, 135, 115] },
  { chain: ["中国", "中国香港", "印度"], goods: "电子集成电路（处理器/控制器 8542.31 主体）", hs: "8542.31",
    ...
    note: "UN Comtrade 中国海关 HS 8542（含 8542.31 + 8542.32 + 8542.39 全章组，对港出口）"
    },
    india: {
    source: 140,
    years: {
    ...
    note: "印度 DGCI&S 官方 PDF（itj.dgciskol.gov.in）：印度自中国香港 HS 8542 进口 2019 $15,130M / 2020 $16,890M / 2021 $22,110M / 2022 $22,220M（印度 HS 8542 自港进口量全球第二，仅次中国）。2023/2024 印度 DGCI&S HS 6 位级明细暂未上链公开"
    },
