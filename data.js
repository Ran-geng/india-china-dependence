...
const TRANSSHIPMENT_TRADE = [
  { chain: ["中国", "泰国", "印度"], goods: "多晶硅料（光伏上游）", hs: "2804.61",
    hsNote: "品目 2804（硅），光伏级多晶硅细分 2804.61",
    surge: true, surgeNote: "中国→泰国 2023→2024 出口 +376%",
    china: { unit: "百万美元", y21: 184, y22: 157, y23: 68, y24: 324, note: "2021 $184M → 2022 $157M → 2023 $68M → 2024 $324M" },
    indiaSide: "印度侧：印度无商业多晶硅/硅锭产能、多晶硅 100% 依赖进口且主要来自中国（MNRE 2025-02 向议会确认）；泰国为全球前三大多晶硅进口方之一，其电池/组件产能向印度出口（印度自泰进口太阳能电池占比较高，TIA 进口伙伴口径）[74][52]。",
    source: 130 },
  { chain: ["中国", "印度尼西亚", "印度"], goods: "太阳能级硅片（光伏上游）", hs: "3818.00",
    hsNote: "品目 3818（电子工业用硅片/掺杂硅），光伏硅片口径",
    surge: true, surgeNote: "中国→印尼 2023→2024 出口 +940%",
    china: { unit: "百万美元", y21: 2, y22: 1, y23: 5, y24: 52, note: "2021 $2M → 2022 $1M → 2023 $5M → 2024 $52M" },
    indiaSide: "印度侧：印度硅片约 98% 自华、几乎全部光伏上游依赖中国（Business Today 2026-06）[74]；印尼光伏制造（组件/电池）快速扩张，是东南亚对印光伏产品出口方之一，且印度曾就「经东南亚再出口」征收反规避税（DGTR 对华太阳能 30% 反倾销含防转口条款）[112]。",
    source: 130 },
  { chain: ["中国", "马来西亚", "印度"], goods: "多晶硅料（光伏上游）", hs: "2804.61",
    hsNote: "品目 2804（硅），光伏级多晶硅细分 2804.61",
    surge: true, surgeNote: "中国→马来 2023→2024 出口 +102%",
    china: { unit: "百万美元", y21: 159, y22: 129, y23: 117, y24: 236, note: "2021 $159M → 2022 $129M → 2023 $117M → 2024 $236M" },
    indiaSide: "印度侧：印度多晶硅依赖中国（MNRE 确认无商业产能）[74]；马来是东南亚光伏制造中心之一，其组件对印出口受印方关注；DRI 2025-09 已破获经马来西亚伪造原产地证案（液压破碎锤约 500 集装箱）[87]。",
    source: 130 },
  { chain: ["中国", "新加坡", "印度"], goods: "盾构机（TBM）", hs: "8430.31",
    hsNote: "品目 8430（隧道掘进机），细分子目 8430.31",
    surge: true, surgeNote: "中国→新加坡 2023→2024 出口 +381%",
    china: { unit: "百万美元", y21: 69, y22: 46, y23: 37, y24: 178, note: "2021 $69M → 2022 $46M → 2023 $37M → 2024 $178M" },
    indiaSide: "印度侧：印度 TBM 进口对华依赖显著（标准 TBM 近年约六成，Takshashila 基于印度商工部数据）[72]；新加坡基建（地铁/填海）大量采购中国 TBM，印度 TBM 采购亦常经东南亚/新加坡渠道（公开合同与行业报告）[38]。",
    source: 130 },
  { chain: ["中国", "阿联酋", "印度"], goods: "盾构机（TBM）", hs: "8430.31",
    hsNote: "品目 8430（隧道掘进机），细分子目 8430.31",
    surge: true, surgeNote: "中国→阿联酋 2021→2024 出口 +4400%（$5M → $225M）",
    china: { unit: "百万美元", y21: 5, y22: 21, y23: 216, y24: 225, note: "2021 $5M → 2022 $21M → 2023 $216M → 2024 $225M" },
    indiaSide: "印度侧：阿联酋基建大爆发期大量采购中国 TBM；印度已查处「经 GCC（迪拜）转口」执法案例（DRI 2024-12 迪拜转口化妆品低估 70%），GCC 为印度关注的中转通道之一 [116][38]。",
    source: 130 },
  { chain: ["中国", "阿联酋", "印度"], goods: "工程机械 · 履带/汽车起重机", hs: "8426",
    hsNote: "品目 8426（起重机），履带吊 8426.49 / 汽车吊 8705.10",
    surge: true, surgeNote: "中国→阿联酋 2023→2024 出口 +149%",
    china: { unit: "百万美元", y21: 31, y22: 41, y23: 92, y24: 229, note: "2021 $31M → 2022 $41M → 2023 $92M → 2024 $229M" },
    indiaSide: "印度侧：印度大型工程机械（履带吊等）以进口为主、中国为主要来源（ICEMA 2025）；阿联酋为中东工程机械集散地，中资履带吊经 GCC 向印度交付的公开案例与印度海关对 GCC 原产地的核查并存 [116]（具体流向以印度 DGCI&S/TIA 门户核验为准）。",
    source: 130 },
  { chain: ["中国", "越南", "印度"], goods: "显示模组（智能手机零部件）", hs: "8524",
    hsNote: "品目 8524（显示面板/模组），跨 8524.11/12/91 等子目",
    surge: true, surgeNote: "中国→越南 2023→2024 出口 +34%（$5.9B → $7.9B）",
    china: { unit: "百万美元", y22: 5480, y23: 5910, y24: 7930, note: "2022 $5.5B → 2023 $5.9B → 2024 $7.9B" },
    indiaSide: "印度侧：越南对印出口 2025 年达 103 亿美元（+14.2%）、手机/电子占近 40%，印方因「含中国原产成分」加强查验（越南官方统计）[90]；印度智能手机零部件整体自华 51.7%（GTRI）[33]。",
    source: 130 },
  { chain: ["中国", "越南", "印度"], goods: "集成电路/半导体器件", hs: "8542",
    hsNote: "品目 8542（集成电路），微处理器 8542.31 / 存储 8542.32",
    surge: true, surgeNote: "中国→越南 2023→2024 出口 +56%（$10.6B → $16.5B）",
    china: { unit: "百万美元", y21: 13960, y22: 12610, y23: 10580, y24: 16480, note: "2021 $14.0B → 2022 $12.6B → 2023 $10.6B → 2024 $16.5B" },
    indiaSide: "印度侧：越南对印电子出口（含半导体元件）激增且印方加强原产地查验 [90]；印度半导体/IC 高度依赖进口，自华直接进口亦处高位（GTRI 口径）[33]。",
    source: 130 },
  { chain: ["中国", "泰国", "印度"], goods: "锂离子蓄电池", hs: "8507.60",
    hsNote: "品目 8507（蓄电池），锂离子子目 8507.60",
    surge: true, surgeNote: "中国→泰国 2023→2024 出口 +48%",
    china: { unit: "百万美元", y21: 216, y22: 417, y23: 398, y24: 589, note: "2021 $216M → 2022 $417M → 2023 $398M → 2024 $589M" },
    indiaSide: "印度侧：印度锂电池约 75–79% 自华（EVTank/Forbes India）[66][75]；泰国为东南亚 EV 制造枢纽、自华电芯采购激增，印度 Pack 厂经东盟采购电芯的中转路径已有报道（ICRA）[31]。",
    source: 130 },
  { chain: ["中国", "新加坡", "印度"], goods: "玩具（玩偶/三轮车及其他）", hs: "9503.00",
    hsNote: "品目 9503（玩具），塑料玩具 9503.00.30 / 玩偶 9503.00.10",
    surge: true, surgeNote: "中国→新加坡 2023→2024 出口 +39%",
    china: { unit: "百万美元", y21: 314, y22: 763, y23: 968, y24: 1350, note: "2021 $314M → 2022 $763M → 2023 $968M → 2024 $1.35B" },
    indiaSide: "印度侧：印度玩具进口前三大买家（Leo Godt/Mattel/Bharat Balloon）华货占 $40.2M，且经新加坡中转 $13.1M、香港 $2.7M（The Dollar Business）[126]；新加坡为中国玩具对印中转通道之一。",
    source: 130 },
  { chain: ["中国", "印度尼西亚", "印度"], goods: "太阳能电池/组件", hs: "8541.42",
    hsNote: "品目 8541（光敏半导体器件），光伏电池 8541.42 / 组件 8541.43",
    surge: true, surgeNote: "中国→印尼 2023→2024 出口 +69%",
    china: { unit: "百万美元", y21: 104, y22: 164, y23: 205, y24: 346, note: "2021 $104M → 2022 $164M → 2023 $205M → 2024 $346M" },
    indiaSide: "印度侧：印度光伏电池自华 65–83%、组件受 ALMM 约束 [73]；印尼光伏制造扩张并承接中国上游，印度 DGTR 对华太阳能反倾销明确覆盖「经东南亚再出口」（含印尼）的反规避条款 [112]。",
    source: 130 },
  { chain: ["中国", "阿联酋", "印度"], goods: "锂离子蓄电池", hs: "8507.60",
    hsNote: "品目 8507（蓄电池），锂离子子目 8507.60",
    surge: true, surgeNote: "中国→阿联酋 2023→2024 出口 +63%",
    china: { unit: "百万美元", y21: 221, y22: 331, y23: 255, y24: 415, note: "2021 $221M → 2022 $331M → 2023 $255M → 2024 $415M" },
    indiaSide: "印度侧：印度锂电池对华依赖约 75–79% [66][75]；阿联酋为印度重要电芯转口/贸易通道（CEPA 框架下印度自 GCC 进口电子与电池增长，印度海关对 UAE 原产地加强核查）[115]。",
    source: 130 },
  { chain: ["中国", "中国香港", "印度"], goods: "显示模组（智能手机零部件）", hs: "8524",
    hsNote: "品目 8524（显示面板/模组）",
    surge: false, surgeNote: "绝对量大、2023→2024 +24%，香港为传统中转地",
    china: { unit: "百万美元", y22: 9410, y23: 7860, y24: 11690, note: "2022 $9.4B → 2023 $7.9B → 2024 $11.7B" },
    indiaSide: "印度侧：香港对印机械/电气出口 FY18–FY20 曾 +678%（印方贸易统计）[88]；中国经香港转口为已知通道（CBIC 原产地新规针对经港转口）[85]。",
    source: 130 },
  { chain: ["中国", "中国香港", "第四国/地区", "印度"], goods: "显示模组 / 集成电路（可能经第四国再入印）", hs: "8524 / 8542",
    hsNote: "四段流示例：中国→香港→（东南亚/中东再加工）→印度，官方数据以中国→香港环节为可靠证据链",
    surge: false, surgeNote: "中国→香港 8524 2024 达 $11.7B、8542 达 $67.6B，均为历史高位",
    china: { unit: "百万美元", note: "8524：2024 $11.7B；8542：2024 $67.6B（2023 $57.9B，+17%）" },
    indiaSide: "印度侧：存在第四国/地区（中国→X→Y→印度）的多段转口——印度已发现经越南、印尼、UAE、新加坡的洗产地案例（DRI/CBIC）[87][115][117]；此类流的中段（Y→印度）HS 级数据需以印度 DGCI&S/TIA 门户核验，本面板仅列中国→X 官方环节。",
    source: 130 }
];
